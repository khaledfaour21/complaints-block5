...
export const EnhancedAchievementsView: React.FC<
  EnhancedAchievementsViewProps
> = ({ className = "" }) => {
        ...
        <div className="flex items-center justify-between">
          <div className="text-left flex-1">
            ...
            <p className="text-gray-500">
              Celebrating the progress and success stories of our community in
              the Fifth Block.
            </p>
          </div>
          {canEdit && (
            ...
            {editing && editing.media.length > 0 && files.length === 0 && (
              <div className="mt-4">
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Upload new files to replace existing media
                </p>
              </div>
            )}
