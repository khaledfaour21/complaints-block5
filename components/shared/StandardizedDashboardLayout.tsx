...
import {
  ChartBarIcon, TrophyIcon, MegaphoneIcon, 
...
export const StandardizedDashboardLayout: React.FC<StandardizedDashboardLayoutProps> = ({
  title,
  subtitle,
  stats,
  userRole,
  ...
  const [activeTab, setActiveTab] = useState<'summary' | 'complaints' | 'content'>('summary');
  ...
  const getQuickAccessRoutes = () => {
    ...
    if (userRole === Role.MANAGER) {
      routes.push(
        { path: '/dashboard/admin', label: 'Admin Dashboard', icon: ChartBarIcon },
        { path: '/dashboard/muktar', label: 'Mukhtar Dashboard', icon: ExclamationTriangleIcon }
      );
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-brand-primary font-cairo">{title}</h1>
        ...
        <div className="flex items-center gap-3">
          ...
          {showContentManagement && (userRole === Role.ADMIN || userRole === Role.MANAGER) && (
            <Link 
      ...
      <div className="transition-all duration-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
              ...
              <div className="card bg-base-100 shadow-xl border-l-4 border-red-500">
                <div className="card-body items-center text-center p-4">
                  ...
                  <div className="stat-value text-2xl text-red-500">{stats.pending}</div>
              ...
              <div className="card bg-base-100 shadow-xl border-l-4 border-yellow-500">
                <div className="card-body items-center text-center p-4">
                  ...
                  <div className="stat-value text-2xl text-yellow-500">{stats.inProgress}</div>
              ...
              <div className="card bg-base-100 shadow-xl border-l-4 border-green-500">
                <div className="card-body items-center text-center p-4">
                  ...
                  <div className="stat-value text-2xl text-green-500">{stats.completed}</div>
              ...
              <div className="card bg-base-100 shadow-xl border-l-4 border-orange-500">
                <div className="card-body items-center text-center p-4">
                  ...
                  <div className="stat-value text-2xl text-orange-500">{stats.highImportance}</div>
              ...
              <div className="card bg-base-100 shadow-xl border-l-4 border-blue-500">
                <div className="card-body items-center text-center p-4">
                  ...
                  <div className="stat-title text-xs">Resolution Rate</div>
                </div>
              </div>
            </div>
            ...
            {quickAccessRoutes.length > 0 && (
              <div className="card bg-gradient-to-r from-brand-lightBg to-white dark:from-[#1a1a1a] dark:to-[#2a2a2a] shadow-xl">
                <div className="card-body">
                  <h3 className="card-title text-brand-primary mb-4">Quick Dashboard Access</h3>
        ...
        {activeTab === 'content' && showContentManagement && (userRole === Role.ADMIN || userRole === Role.MANAGER) && (
          <div>
