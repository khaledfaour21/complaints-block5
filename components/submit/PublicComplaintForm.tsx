  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      const trackId = await api.submitComplaint({
        ...
        neighborhood: "Default Neighborhood", // Since it's not in the form
        complaint_type: "other", // Default type since not specified in form
        priority: "low",
        suggestedSolution: "",
        files,
      });
        ...
        <div className="card w-full max-w-2xl bg-base-100 shadow-2xl border-t-8 border-green-500 animate-fade-in-up">
          <div className="card-body items-center text-center p-10">
            ...
            <p className="text-gray-500 mb-6">
              Your complaint has been registered and forwarded to our team. We
              will assign it to the appropriate Mukhtar for handling.
            </p>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
        ...
        <div className="bg-brand-accent/5 rounded-xl p-4 border border-brand-accent/10">
          ...
          <ul className="text-sm text-gray-600 space-y-1">
            <li>
              • Your complaint status will be set to <strong>Pending</strong>
            </li>
            <li>
              • It will be assigned <strong>Low Importance</strong> by default
            </li>
